...
function HeroSection() {
  const scrollToContact = () => {
    ...
    // Track lead when they click Book Consultation
    if (window.fbq) {
  ...
  return (
    <section id="home" className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center h-full px-6 md:px-20 max-w-7xl">
        {/* Badge */}

        <div className="bg-blue-500/20 border border-blue-500 text-blue-300 px-4 py-2 rounded-full w-fit text-sm mb-6">
          🚀 Modern Websites • SEO • Fast Performance
        </div>

        {/* Heading */}

        <h1 className="text-gray-50 text-4xl md:text-7xl font-bold leading-tight max-w-4xl">
        ...
        <p className="text-lg md:text-xl mt-6 text-gray-300 max-w-2xl leading-8">
        ...
        <div className="flex flex-wrap gap-5 mt-10">
          ...
          <a
            ...
            className="flex items-center gap-3 bg-green-500 hover:bg-green-600 px-8 py-4 rounded-xl font-semibold transition hover:scale-105"
          >
            <FaWhatsapp size={28} />
            WhatsApp Us
          </a>
        ...
        <div className="hidden md:flex flex-wrap gap-8 mt-14 text-gray-300">
          <div>
